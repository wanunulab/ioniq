...
class Ui_PythIon(object):
    def setupUi(self, PythIon):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Designer Files\\../pythionlogo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.loadbutton.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        ...
        self.cutbutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.nextfilebutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.baselinebutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.previousfilebutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.analyzebutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.invertbutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.fitbutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.clearscatterbutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.loaddatabutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.LPentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.LPentry.setObjectName("LPentry")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.LPentry)
        ...
        self.outputsamplerateentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.outputsamplerateentry.setObjectName("outputsamplerateentry")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.outputsamplerateentry)
        ...
        self.eventbufferentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.eventbufferentry.setObjectName("eventbufferentry")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.eventbufferentry)
        ...
        self.thresholdentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.thresholdentry.setObjectName("thresholdentry")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.thresholdentry)
        ...
        self.levelthresholdentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.levelthresholdentry.setObjectName("levelthresholdentry")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.levelthresholdentry)
        ...
        self.groupBox2.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.groupBox2.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.verticalGroupBox_5.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.gobutton.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.gobutton.setObjectName("gobutton")
        self.gridLayout.addWidget(self.gobutton, 1, 2, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.eventnumberentry.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.eventnumberentry.setObjectName("eventnumberentry")
        self.gridLayout.addWidget(self.eventnumberentry, 0, 3, 1, 1)
        self.verticalLayout_6.addLayout(self.gridLayout)
        self.gridLayout_11.addWidget(self.verticalGroupBox_5, 0, 1, 1, 1, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.signalplot.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
...
"border-color: rgb(0, 0, 0);")
        self.eventplot.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        ...
        self.fracbins.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.delibins.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.delirange0.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.delirange1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dwellbins.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dwellrange0.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dwellrange1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dtbins.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dtrange0.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.dtrange1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.menuPythion_Tests = QtWidgets.QMenu(self.menuTools)
        self.menuPythion_Tests.setObjectName("menuPythion_Tests")
        ...
        self.actionSpike_Analyzer = QtGui.QAction(PythIon)
        self.actionSpike_Analyzer.setObjectName("actionSpike_Analyzer")
        self.actionFilter_Kit = QtGui.QAction(PythIon)
        self.actionFilter_Kit.setObjectName("actionFilter_Kit")
        self.actionSpike_Analysis_Test_1 = QtGui.QAction(PythIon)
        self.actionSpike_Analysis_Test_1.setObjectName("actionSpike_Analysis_Test_1")
        self.actionSpike_Analysis_Test_2 = QtGui.QAction(PythIon)
        self.actionSpike_Analysis_Test_2.setObjectName("actionSpike_Analysis_Test_2")
        self.actionStatSplit_Analysis_Test_1 = QtGui.QAction(PythIon)
        ...
        self.actionNormalize_to_G = QtGui.QAction(PythIon)
        ...
        self.menuPythion_Tests.addAction(self.actionSpike_Analysis_Test_2)
        self.menuPythion_Tests.addSeparator()
        self.menuPythion_Tests.addAction(self.actionStatSplit_Analysis_Test_1)
        self.menuTools.addAction(self.actionSpike_Analyzer)
    ...
    def retranslateUi(self, PythIon):
        ...
        self.menuTools.setTitle(_translate("PythIon", "Tools"))
        self.menuPythion_Tests.setTitle(_translate("PythIon", "Pythion Tests"))
        ...
        self.actionSpike_Analyzer.setText(_translate("PythIon", "Spike Analyzer"))
        self.actionFilter_Kit.setText(_translate("PythIon", "Filter Kit"))
